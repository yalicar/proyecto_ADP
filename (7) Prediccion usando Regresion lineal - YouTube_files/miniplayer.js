...
g.k.uB=function(){this.tooltip=new g.nP(this.player,this);g.H(this,this.tooltip);g.KL(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.pc=new g.KM(this.player);g.H(this,this.pc);this.bh=new g.V({D:"div",K:"ytp-miniplayer-scrim"});g.H(this,this.bh);this.bh.xa(this.element);this.N(this.bh.element,"click",this.Jx);var a=new g.V({D:"button",Ba:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Cerrar"},S:[g.SJ()]});g.H(this,a);a.xa(this.bh.element);this.N(a.element,"click",this.Ei);
...
Ba:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Cerrar"},S:[g.SJ()]});g.H(this,a);a.xa(this.yx.element);this.N(a.element,"click",this.Ei);a=new g.V({D:"button",Ba:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Cerrar"},S:[g.XJ()]});g.H(this,a);a.xa(this.yx.element);this.N(a.element,"click",this.FR);this.N(this.player,"presentingplayerstatechange",this.xc);this.N(this.player,"appresize",this.kb);this.N(this.player,"fullscreentoggled",this.kb);this.kb()};
